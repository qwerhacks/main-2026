<div class="sponsors-container p-8 max-w-4xl mx-auto text-white">
	<h1 class="text-4xl md:text-6xl mb-12 text-center" style="font-family: 'Ranille Normal', serif; color: #C5A059; text-shadow: 0 0 10px rgba(197, 160, 89, 0.5);">
		Our Sponsors
	</h1>
	...
	<p class="text-lg text-center mt-12" style="font-family: 'Spectral', serif;">
		Interested in sponsoring QWER Hacks? <a href="mailto:qwerhacks@gmail.com" class="underline hover:text-yellow-200">Contact us!</a>
	</p>
</div>
